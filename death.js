...
//      ---------------------------------map9-------------------------------------
         ...
         //this.map.setCollision(25, true, 'Layer1');
         //this.map.setCollision(27, true, 'Layer1');
         hi = game.add.sprite(game.world.centerX*4/3, game.world.centerY-10, "p1Anim1");
         game.physics.arcade.enable(hi);
         //game.physics.p2.enable(hi);
         hi.body.collideWorldBounds = true;
         hi.frame = 1;
...
*/         
         ...
         p1healthBarRed = game.add.sprite (game.world.centerX*4/3 - 10, game.world.centerY-30-10, "healthBarRedIMG");
         p1healthBarRed.scale.y = 0.06;
         p1healthBarRed.scale.x = 0.2;
         //p1healthBarRed.anchor.setTo(0.5);
         game.physics.arcade.enable(p1healthBarRed);
         
         p1healthBarGreen = game.add.sprite(game.world.centerX*4/3 - 10, game.world.centerY-30-10, "healthBarGreenIMG")
         p1healthBarGreen.scale.y = 0.06;
         p1healthBarGreen.scale.x = 0.2;
         //p1healthBarGreen.anchor.setTo(0.5);
         game.physics.arcade.enable(p1healthBarGreen);
...
*/         
 ...
 hi = game.add.sprite(game.world.centerX*4/3, game.world.centerY+100, "p1Anim1");
 game.physics.arcade.enable(hi);
 //game.physics.p2.enable(hi);
 hi.body.collideWorldBounds = true;
 hi.frame = 1;
...
*/         
 ...
 p1healthBarRed = game.add.sprite (game.world.centerX*4/3 - 10, game.world.centerY-30+100, "healthBarRedIMG");
 p1healthBarRed.scale.y = 0.06;
 p1healthBarRed.scale.x = 0.2;
 //p1healthBarRed.anchor.setTo(0.5);
 game.physics.arcade.enable(p1healthBarRed);
 
 p1healthBarGreen = game.add.sprite(game.world.centerX*4/3 - 10, game.world.centerY-30+100, "healthBarGreenIMG")
 p1healthBarGreen.scale.y = 0.06;
 p1healthBarGreen.scale.x = 0.2;
 //p1healthBarGreen.anchor.setTo(0.5);
 game.physics.arcade.enable(p1healthBarGreen);
...
game.physics.arcade.enable(p2healthBarGreen);
        ...
        this.getweapon = game.add.text(550, 1200, 'Got 10 Bombs', { font: '40px Luckiest Guy', fill: '#FFFFFF' });
    ...
    drawGame: function () {
        if (this.gameState == 0) {
            ...
            boss1 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            ...
            boss2 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            ...
            // enemySpawnTimer1 = game.time.events.add(Phaser.Timer.SECOND, this.spawnNewBoss, this);
    ...
    /*spawnNewEnemy: function () {
        for (var ToSpawn = 0; ToSpawn < 30; ToSpawn++) {
            if (inter % 2 == 1) {
        ...
        for (var ToSpawn = 0; ToSpawn < 12; ToSpawn++){
            if (inter%2 == 1){
                ...
                if (this.enemySpawnLimit >= enemyTest2ArrayP2.length){
                    ...
                    bossp2.hp=15;
                    bossp2.time=0, bossp2.rate=1500;
                    bossP2Array.direction='leftdown';
                    bossp2.isDead = false;
            
                    game.physics.arcade.enable(boss2);
                    console.log("new boss2");
    ...
    //----------------------------------------------------------------------------------------------------------
    bulletHasHithi: function (bullet, hi) {
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
    ...
    if (currentGun == 1) {
            ...
            if (healthP1 <= 0) {
                /*var bloodSpat = game.add.sprite(hi.body.x, hi.body.y, "blood");
                bloodSpat.scale.x = .2;
                bloodSpat.scale.y = .2;
                helper.splatArray.push(bloodSpat);
                zombiedead += 1;
            ...
            bullet.kill();
                    ...
                    gunP2Stuff.explosion = game.add.sprite(hi.body.x, hi.body.y, "explosionAnim");
                    game.physics.arcade.enable(gunP2Stuff.explosion);
                    gunP2Stuff.explosion.scale.x = .25;
                    gunP2Stuff.explosion.scale.y = .25;
                    gunP2Stuff.explosion.anchor.setTo(0.5);
    ...
    bulletHasHitp2: function (bullet, p2) {
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
        ...
        if (currentGunp1 == 1) {
            ...
            bullet.kill();
                    ...
                    gunP1Stuff.explosion = game.add.sprite(p2.body.x, p2.body.y, "explosionAnim");
                    game.physics.arcade.enable(gunP1Stuff.explosion);
                    gunP1Stuff.explosion.scale.x = .25;
                    gunP1Stuff.explosion.scale.y = .25;
                    gunP1Stuff.explosion.anchor.setTo(0.5);
    ...
    explosionhashithi: function(explosion, hi){
    ...
    explosionhashitp2: function(explosion, p2){
        if(explosion == gunP2Stuff.explosion && once2){
            healthP2 -= 8;
            once2=0;
            console.log(healthP1);
            if(healthP2<=0){
                var bloodSpat = game.add.sprite(p2.body.x,p2.body.y, "blood");
                bloodSpat.scale.x = .2;
                bloodSpat.scale.y = .2;
                helper.splatArray.push(bloodSpat);
                zombiedead += 1;
        ...
        if (this.gameState == 1) {
            ...
            if (!paused) {
                ...
                if (Math.abs(boss1.body.y - hi.body.y) <= 300 && bossp1.walking && boss1.body.y >= 0 && !bossp1.isDead) {
                    if (game.time.time > bossp1.time) {
                        ...
                        if (bossp1.direction == 'left') {
                            ...
                            this.boss_bullet.body.velocity.x = -450;
                            ...
                            this.boss_bullet.body.velocity.y = -450;
                ...
                for (var index = helper.bulletArrayP1.length - 1; index >= 0; index--) {
                    ...
                    //game.physics.arcade.collide(helper.bulletArrayP1[index], hi, this.bulletHasHithi, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP1[index], p2, this.bulletHasHitp2, null, this);
                ...
                for (var index = helper.bulletArrayP2.length - 1; index >= 0; index--) {
                    ...
                    game.physics.arcade.collide(helper.bulletArrayP2[index], hi, this.bulletHasHithi, null, this);
                    // game.physics.arcade.collide(helper.bulletArrayP2[index], p2, this.bulletHasHitp2, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP2[index], this.layer, this.bullethitlayer, null, this);
                }

                for(var index = gunP1Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], p2, this.explosionhashitp2, null, this);
                }
                for(var index = gunP2Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], hi, this.explosionhashithi, null, this);
                }
                ...
                if (zombiedead >= 15) {
                    ...
                    if (boss3.body.velocity.x < 0 && Math.abs(boss3.body.y - p2.body.y) <= 40) {
                        boss3.animations.play("left");
                        bossp3.direction = 'left';
                    }
                    else if (boss3.body.velocity.x > 0 && Math.abs(boss3.body.y - p2.body.y) <= 30) {
                        boss3.animations.play("right");
                        bossp3.direction = 'right';
                    }
                    else if (boss3.body.velocity.y < 0 && Math.abs(boss3.body.x - p2.body.x) <= 30) {
                ...
                if (zombiedead >= 30 && bossp1.isDead && bossp2.isDead && bossp3.isDead && bossp4.isDead) {
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

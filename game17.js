...
*/
        ...
        this.lastwin  = game.add.audio('lastwin');
...
/*
   ...
   */         
            ...
            boss1 = game.add.sprite(540, -100, "boss4");
            ...
            boss2 = game.add.sprite(540, -100, "boss4");
        ...
        for (var ToSpawn = 0; ToSpawn < 12; ToSpawn++){
            if (inter%2 == 1){
                if (this.enemySpawnLimit >= enemyTest2ArrayP1.length){
                    inter ++;
                    enemyTest2P1 = game.add.sprite(game.world.randomX + game.width, game.world.randomY + game.height, "boss4");
                ...
                if (this.enemySpawnLimit >= enemyTest2ArrayP2.length){
                    enemyTest2P2 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss4");
...
// 0 up 1 down 2 right 3 left
                ...
                for(var i = enemyTest2ArrayP2.length - 1; i >= 0 ; i--){
                    ...
                    if(Math.abs(enemyTest2ArrayP2[i].body.y-p2.body.y)<=300 && enemyTest2ArrayP2[i].body.y>=0 && !enemyTest2ArrayP2[i].isDead){
                        if(game.time.time > enemyTest2ArrayP2[i].time){
                            //console.log('0.0');
                            this.boss_bullet = game.add.sprite(enemyTest2ArrayP2[i].body.x, enemyTest2ArrayP2[i].body.y, "boss4_bullet");
                            ...
                            if(enemyTest2ArrayP2[i].direction=='left'){
                                    ...
                                    this.boss_bullet.body.velocity.x= -800;
                                ...
                                this.boss_bullet.body.velocity.y= -800;
                                ...
                                enemyTest2ArrayP2[i].frame = 44;
                                    ...
                                    this.boss_bullet.body.velocity.y= 550;
                                    this.boss_bullet.body.velocity.x= -550;
                ...
                if(Math.abs(enemyTest2ArrayP1[i].body.y-hi.body.y)<=300 && enemyTest2ArrayP1[i].body.y>=0 && !enemyTest2ArrayP1[i].isDead){
                    if(game.time.time > enemyTest2ArrayP1[i].time){
                        this.boss_bullet = game.add.sprite(enemyTest2ArrayP1[i].body.x, enemyTest2ArrayP1[i].body.y, "boss4_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(bossp1.walking)
                    boss1.game.physics.arcade.moveToObject(boss1, hi, 80);

                if(bossp2.walking)
                    boss2.game.physics.arcade.moveToObject(boss2, p2, 80);
               ...
               // enemyTest.game.physics.arcade.moveToObject(enemyTest, hi, 50);
                ...
                for (var i = enemyTest2ArrayP1.length - 1; i >= 0 ; i--){
                    if (!enemyTest2ArrayP1[i].isDead){
                        ...
                        enemyTest2ArrayP1[i].game.physics.arcade.moveToObject(enemyTest2ArrayP1[i], hi, 80);
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                for(var index = helper.bulletArrayP1.length-1;index>=0;index--){
                    game.physics.arcade.overlap(helper.bulletArrayP1[index], boss1, this.bulletHasHitBoss1, null, this);
                    game.physics.arcade.overlap(helper.bulletArrayP1[index], boss2, this.bulletHasHitBoss2, null, this);
                }
                for(var index = helper.bulletArrayP2.length-1;index>=0;index--){
                    game.physics.arcade.overlap(helper.bulletArrayP2[index], boss1, this.bulletHasHitBoss1, null, this);
                    game.physics.arcade.overlap(helper.bulletArrayP2[index], boss2, this.bulletHasHitBoss2, null, this);
                }
                ...
                for (var i = enemyTest2ArrayP2.length - 1; i >= 0; i--){
                    if (!enemyTest2ArrayP2[i].isDead){
                        ...
                        enemyTest2ArrayP2[i].game.physics.arcade.moveToObject(enemyTest2ArrayP2[i], p2, 80);

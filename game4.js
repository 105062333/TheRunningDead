...
this.map.setCollision([639,640,643,644,647,648], true, 'Layer1');
    ...
    drawGame: function() {
        if (this.gameState == 0){
            ...
            hi = game.add.sprite(game.world.centerX*4/3, game.world.centerY-30, "p1Anim1");
...
/*
   ...
   */         
            ...
            p1healthBarRed = game.add.sprite (game.world.centerX*4/3 - 10, game.world.centerY-30-30, "healthBarRedIMG");
            ...
            p1healthBarGreen = game.add.sprite(game.world.centerX*4/3 - 10, game.world.centerY-30-30, "healthBarGreenIMG")
            ...
            p2 = game.add.sprite(400, game.world.centerY+50, "p2Anim1");
            ...
            p2healthBarRed = game.add.sprite(400-10, game.world.centerY-30+50, "healthBarRedIMG");
            ...
            p2healthBarGreen = game.add.sprite(400-10, game.world.centerY-30+50, "healthBarGreenIMG")
            ...
            boss1 = game.add.sprite(540, -100, "boss");
            ...
            boss2 = game.add.sprite(540, -100, "boss");
            ...
            boss3 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            //bossP2Array.push(boss2);
            boss3.anchor.set(0.5, 0.5);
            bossp3.walking=false;
            bossp3.hp=15;
            bossp3.time=0, bossp3.rate=1500;
            bossp3.direction='leftdown';
            bossp3.isDead = false;
    
            game.physics.arcade.enable(boss3);

            boss4 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            //bossP2Array.push(boss2);
            boss4.anchor.set(0.5, 0.5);
            bossp4.walking=false;
            bossp4.hp=15;
            bossp4.time=0, bossp4.rate=1500;
            bossp4.direction='leftdown';
            bossp4.isDead = false;
    
            game.physics.arcade.enable(boss4);
            
            boss5 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            //bossP2Array.push(boss2);
            boss5.anchor.set(0.5, 0.5);
            bossp5.walking=false;
            bossp5.hp=15;
            bossp5.time=0, bossp5.rate=1500;
            bossp5.direction='leftdown';
            bossp6.isDead = false;
    
            game.physics.arcade.enable(boss5);

            boss6 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss");
            //bossP2Array.push(boss2);
            boss6.anchor.set(0.5, 0.5);
            bossp6.walking=false;
            bossp6.hp=15;
            bossp6.time=0, bossp6.rate=1500;
            bossp6.direction='leftdown';
            bossp6.isDead = false;
    
            game.physics.arcade.enable(boss6);
            ...
            boss3.animations.add('left', [12, 13, 14, 15], 10, true);
            boss3.animations.add('right', [24, 25, 26, 27], 10, true);
            boss3.animations.add('up', [36, 37, 38, 39], 10, true);
            boss3.animations.add('down', [0, 1, 2, 3], 10, true);
            boss3.animations.add('leftdown', [4, 5, 6, 7], 10, true);
            boss3.animations.add('rightdown', [16, 17, 18, 19], 10, true);
            boss3.animations.add('rightup', [28, 29, 30, 31], 10, true);
            boss3.animations.add('leftup', [40, 41, 42, 43], 10, true);

            boss4.animations.add('left', [12, 13, 14, 15], 10, true);
            boss4.animations.add('right', [24, 25, 26, 27], 10, true);
            boss4.animations.add('up', [36, 37, 38, 39], 10, true);
            boss4.animations.add('down', [0, 1, 2, 3], 10, true);
            boss4.animations.add('leftdown', [4, 5, 6, 7], 10, true);
            boss4.animations.add('rightdown', [16, 17, 18, 19], 10, true);
            boss4.animations.add('rightup', [28, 29, 30, 31], 10, true);
            boss4.animations.add('leftup', [40, 41, 42, 43], 10, true);
            
            boss5.animations.add('left', [12, 13, 14, 15], 10, true);
            boss5.animations.add('right', [24, 25, 26, 27], 10, true);
            boss5.animations.add('up', [36, 37, 38, 39], 10, true);
            boss5.animations.add('down', [0, 1, 2, 3], 10, true);
            boss5.animations.add('leftdown', [4, 5, 6, 7], 10, true);
            boss5.animations.add('rightdown', [16, 17, 18, 19], 10, true);
            boss5.animations.add('rightup', [28, 29, 30, 31], 10, true);
            boss5.animations.add('leftup', [40, 41, 42, 43], 10, true);

            boss6.animations.add('left', [12, 13, 14, 15], 10, true);
            boss6.animations.add('right', [24, 25, 26, 27], 10, true);
            boss6.animations.add('up', [36, 37, 38, 39], 10, true);
            boss6.animations.add('down', [0, 1, 2, 3], 10, true);
            boss6.animations.add('leftdown', [4, 5, 6, 7], 10, true);
            boss6.animations.add('rightdown', [16, 17, 18, 19], 10, true);
            boss6.animations.add('rightup', [28, 29, 30, 31], 10, true);
            boss6.animations.add('leftup', [40, 41, 42, 43], 10, true);
    ...
    spawnNewEnemy: function(){
        for (var ToSpawn = 0; ToSpawn < 40; ToSpawn++){
            if (inter%2 == 1){
    ...
    bulletHasHitEnemyP1: function(bullet, enemy){
     ...
     bulletHasHitEnemyP2: function(bullet, enemy){
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
     ...
     bulletHasHitBoss3: function(bullet, Boss){
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
    ...
    bulletHasHitBoss4: function(bullet, Boss){
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
    ...
    bulletHasHitBoss5: function(bullet, Boss){
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
    ...
    bulletHasHitBoss6: function(bullet, Boss){
        if(bullet==helper.bullets){
            if(currentGunp1!=3)
            bullet.kill();
        } else
     ...
     explosionHasHitBoss3: function(explosion, Boss){
        //console.log("explode");
        console.log(once1);
        if (explosion == gunP1Stuff.explosion){
            scoreP1 += 5;
    ...
    explosionHasHitBoss4: function(explosion, Boss){
        //console.log("explode");
        console.log(once1);
        if (explosion == gunP1Stuff.explosion){
            scoreP1 += 5;
    ...
    explosionHasHitBoss5: function(explosion, Boss){
        //console.log("explode");
        console.log(once1);
        if (explosion == gunP1Stuff.explosion){
            scoreP1 += 5;
    ...
    explosionHasHitBoss6: function(explosion, Boss){
        //console.log("explode");
        console.log(once1);
        if (explosion == gunP1Stuff.explosion){
            scoreP1 += 5;
...
// 0 up 1 down 2 right 3 left
                ...
                if(Math.abs(boss1.body.y-hi.body.y)<=300 && bossp1.walking && boss1.body.y>=0 && !bossp1.isDead){
                    if(game.time.time > bossp1.time){
                        this.boss_bullet = game.add.sprite(boss1.body.x, boss1.body.y, "boss_bullet");
                        ...
                        else if(bossp1.direction=='right'){
                        ...
                        else if(bossp1.direction=='leftdown'){

                                this.boss_bullet.body.velocity.y= 200;
                                this.boss_bullet.body.velocity.x= -200;
                            
                            boss1.frame = 46;
                        } else if(bossp1.direction=="rightdown"){

                                this.boss_bullet.body.velocity.y=200;
                                this.boss_bullet.body.velocity.x=200;                                
                            
                            boss1.frame = 47;
                        } else if(bossp1.direction=="rightup"){
                                ...
                                boss1.frame = 8;
                        } else if(bossp1.direction=="leftup"){
                        ...
                        bossp1.time = game.time.time+bossp1.rate;
                    }
                }

                if(Math.abs(boss2.body.y-p2.body.y)<=300 && bossp2.walking && boss2.body.y>=0 && !bossp2.isDead){
                    if(game.time.time > bossp2.time){
                        this.boss_bullet = game.add.sprite(boss2.body.x, boss2.body.y, "boss_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                        ...
                        if(bossp2.direction=='left'){
                        ...
                        else if(bossp2.direction=='right'){
                            ...
                            boss2.frame = 44;
                        ...
                        else if(bossp2.direction=='leftdown'){

                                this.boss_bullet.body.velocity.y= 150;
                                this.boss_bullet.body.velocity.x= -150;
                            
                                boss2.frame = 46;
                        } else if(bossp2.direction=="rightdown"){

                                this.boss_bullet.body.velocity.y=150;
                                this.boss_bullet.body.velocity.x=150;                                
                            
                                boss2.frame = 47;
                        } else if(bossp2.direction=="rightup"){
                                ...
                                boss2.frame = 8;
                        } else if(bossp2.direction=="leftup"){
                        ...
                        bossp2.time = game.time.time+bossp2.rate;
                    }
                }
                if(Math.abs(boss3.body.y-hi.body.y)<=300 && bossp3.walking && boss3.body.y>=0 && !bossp3.isDead){
                    if(game.time.time > bossp3.time){
                        this.boss_bullet = game.add.sprite(boss3.body.x, boss3.body.y, "boss_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                        ...
                        if(bossp3.direction=='left'){
                        ...
                        else if(bossp3.direction=='right'){
                            ...
                            boss3.frame = 44;
                        ...
                        else if(bossp3.direction=='leftdown'){

                                this.boss_bullet.body.velocity.y= 150;
                                this.boss_bullet.body.velocity.x= -150;
                            
                                boss3.frame = 46;
                        } else if(bossp3.direction=="rightdown"){

                                this.boss_bullet.body.velocity.y=150;
                                this.boss_bullet.body.velocity.x=150;                                
                            
                                boss3.frame = 47;
                        } else if(bossp3.direction=="rightup"){
                                ...
                                boss3.frame = 8;
                        } else if(bossp3.direction=="leftup"){
                        ...
                        bossp3.time = game.time.time+bossp3.rate;
                    }
                }
                if(Math.abs(boss4.body.y-p2.body.y)<=300 && bossp4.walking && boss4.body.y>=0 && !bossp4.isDead){
                    if(game.time.time > bossp4.time){
                        this.boss_bullet = game.add.sprite(boss4.body.x, boss4.body.y, "boss_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                        ...
                        if(bossp4.direction=='left'){
                        ...
                        else if(bossp4.direction=='right'){
                            ...
                            boss4.frame = 44;
                        ...
                        else if(bossp4.direction=='leftdown'){

                                this.boss_bullet.body.velocity.y= 150;
                                this.boss_bullet.body.velocity.x= -150;
                            
                                boss4.frame = 46;
                        } else if(bossp4.direction=="rightdown"){

                                this.boss_bullet.body.velocity.y=150;
                                this.boss_bullet.body.velocity.x=150;                                
                            
                                boss4.frame = 47;
                        } else if(bossp4.direction=="rightup"){
                                ...
                                boss4.frame = 8;
                        } else if(bossp4.direction=="leftup"){
                        ...
                        bossp4.time = game.time.time+bossp4.rate;
                    }
                }

                if(Math.abs(boss5.body.y-hi.body.y)<=300 && bossp5.walking && boss5.body.y>=0 && !bossp5.isDead){
                    if(game.time.time > bossp5.time){
                        this.boss_bullet = game.add.sprite(boss5.body.x, boss5.body.y, "boss_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                        ...
                        else if(bossp5.direction=='right'){
                        ...
                        else if(bossp5.direction=='leftdown'){

                                this.boss_bullet.body.velocity.y= 150;
                                this.boss_bullet.body.velocity.x= -150;
                            
                            boss5.frame = 46;
                        } else if(bossp5.direction=="rightdown"){

                                this.boss_bullet.body.velocity.y=150;
                                this.boss_bullet.body.velocity.x=150;                                
                            
                            boss5.frame = 47;
                        } else if(bossp5.direction=="rightup"){
                                ...
                                boss5.frame = 8;
                        } else if(bossp5.direction=="leftup"){
                        ...
                        bossp5.time = game.time.time+bossp5.rate;
                    }
                }

                if(Math.abs(boss6.body.y-p2.body.y)<=300 && bossp6.walking && boss6.body.y>=0 && !bossp6.isDead){
                    if(game.time.time > bossp6.time){
                        this.boss_bullet6 = game.add.sprite(boss6.body.x, boss6.body.y, "boss_bullet");
                        this.boss_bullet6.scale.x=.2;
                        this.boss_bullet6.scale.y=.2;
                        this.boss_bullet6.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet6);
                        boss_bulletArray.push(this.boss_bullet6);

                        this.boss_ball.play();

                        if(bossp6.direction=='left'){

                                this.boss_bullet6.body.velocity.y= 0;
                                this.boss_bullet6.body.velocity.x= -200;
                            
                            boss6.frame = 11;
                        }
                        else if(bossp6.direction=='right'){
                        ...
                        else if(bossp6.direction=='up'){

                            this.boss_bullet6.body.velocity.y= -200;
                            this.boss_bullet6.body.velocity.x= 0;
                        
                            boss6.frame = 45;
                        }
                        else if(bossp6.direction=='down'){
                        ...
                        else if(bossp6.direction=='leftdown'){

                                this.boss_bullet6.body.velocity.y= 150;
                                this.boss_bullet6.body.velocity.x= -150;
                            
                            boss6.frame = 46;
                        } else if(bossp6.direction=="rightdown"){

                                this.boss_bullet6.body.velocity.y=150;
                                this.boss_bullet6.body.velocity.x=150;                                
                            
                            boss6.frame = 47;
                        } else if(bossp6.direction=="rightup"){
                                ...
                                boss6.frame = 8;
                        } else if(bossp6.direction=="leftup"){
                        ...
                        bossp6.time = game.time.time+bossp6.rate;
                    }
                }
                ...
                game.physics.arcade.collide(boss3, this.layer);
                game.physics.arcade.collide(boss4, this.layer);
                game.physics.arcade.collide(boss5, this.layer);
                game.physics.arcade.collide(boss6, this.layer);
                ...
                game.physics.arcade.collide(hi, boss3);
                game.physics.arcade.collide(p2, boss3);   
                game.physics.arcade.collide(hi, boss4);
                game.physics.arcade.collide(p2, boss4);  
                game.physics.arcade.collide(hi, boss5);
                game.physics.arcade.collide(p2, boss5);   
                game.physics.arcade.collide(hi, boss6);
                game.physics.arcade.collide(p2, boss6); 
                ...
                if(bossp1.walking)
                    boss1.game.physics.arcade.moveToObject(boss1, hi, 50);

                if(bossp2.walking)
                    boss2.game.physics.arcade.moveToObject(boss2, p2, 50);

                if(bossp3.walking)
                    boss3.game.physics.arcade.moveToObject(boss3, hi, 50);

                if(bossp4.walking)
                    boss4.game.physics.arcade.moveToObject(boss4, p2, 50);

                if(bossp5.walking)
                    boss5.game.physics.arcade.moveToObject(boss5, hi, 50);

                if(bossp6.walking)
                    boss6.game.physics.arcade.moveToObject(boss6, p2, 50);
                    ...
                    for(var index = gunP1Stuff.explosionArray.length-1;index>=0;index--){
                        ...
                        game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss3, this.explosionHasHitBoss3, null, this);
                        game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss4, this.explosionHasHitBoss4, null, this);
                        game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss5, this.explosionHasHitBoss5, null, this);
                        game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss6, this.explosionHasHitBoss6, null, this);
                    }
                    ...
                    for(var index = gunP2Stuff.explosionArray.length-1;index>=0;index--){
                        ...
                        game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss3, this.explosionHasHitBoss3, null, this);
                        game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss4, this.explosionHasHitBoss4, null, this);
                        game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss5, this.explosionHasHitBoss5, null, this);
                        game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss6, this.explosionHasHitBoss6, null, this);
                    }      
               ...
               // enemyTest.game.physics.arcade.moveToObject(enemyTest, hi, 50);
                ...
                for (var i = enemyTest2ArrayP1.length - 1; i >= 0 ; i--){
                    if (!enemyTest2ArrayP1[i].isDead){
                        ...
                        enemyTest2ArrayP1[i].game.physics.arcade.moveToObject(enemyTest2ArrayP1[i], hi, 50);
                        ...
                        game.physics.arcade.collide(helper.bulletsP2, enemyTest2ArrayP1[i], this.bulletHasHitEnemyP2, null, this);
                        ...
                        for(var index = helper.bulletArrayP2.length-1;index>=0;index--){
                            game.physics.arcade.collide(helper.bulletArrayP2[index], enemyTest2ArrayP1[i], this.bulletHasHitEnemyP2, null, this);
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                for(var index = helper.bulletArrayP1.length-1;index>=0;index--){
                    ...
                    game.physics.arcade.collide(helper.bulletArrayP1[index], boss3, this.bulletHasHitBoss3, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP1[index], boss4, this.bulletHasHitBoss4, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP1[index], boss5, this.bulletHasHitBoss5, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP1[index], boss6, this.bulletHasHitBoss6, null, this);
                }
                for(var index = helper.bulletArrayP2.length-1;index>=0;index--){
                    ...
                    game.physics.arcade.collide(helper.bulletArrayP2[index], boss3, this.bulletHasHitBoss3, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP2[index], boss4, this.bulletHasHitBoss4, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP2[index], boss5, this.bulletHasHitBoss5, null, this);
                    game.physics.arcade.collide(helper.bulletArrayP2[index], boss6, this.bulletHasHitBoss6, null, this);
                }
                ...
                for (var i = enemyTest2ArrayP2.length - 1; i >= 0; i--){
                    if (!enemyTest2ArrayP2[i].isDead){
                        ...
                        enemyTest2ArrayP2[i].game.physics.arcade.moveToObject(enemyTest2ArrayP2[i], p2, 50);
                        ...
                        for(var index = helper.bulletArrayP2.length-1;index>=0;index--){
                            game.physics.arcade.collide(helper.bulletArrayP2[index], enemyTest2ArrayP2[i], this.bulletHasHitEnemyP2, null, this);
                        }
                ...
                if(zombiedead >= 20){
                    ...
                    game.physics.arcade.collide(enemyTest2ArrayP2[i], this.layer);
                        ...
                        if(boss3.body.velocity.x < 0 && Math.abs(boss3.body.y-hi.body.y)<=40){
                            boss3.animations.play("left");
                            bossp3.direction = 'left';
                        }
                        else if(boss3.body.velocity.x > 0 && Math.abs(boss3.body.y-hi.body.y)<=30){
                            boss3.animations.play("right");
                            bossp3.direction = 'right';
                        }
                        else if(boss3.body.velocity.y < 0 && Math.abs(boss3.body.x-hi.body.x)<=30){
                            boss3.animations.play("up");
                            bossp3.direction = 'up';
                        }
                        else if(boss3.body.velocity.y > 0 && Math.abs(boss3.body.x-hi.body.x)<=30){
                            boss3.animations.play("down");
                            bossp3.direction = 'down';
                        }
                        else if(boss3.body.velocity.x < 0 && boss3.body.velocity.y>0){
                            boss3.animations.play("leftdown");
                            bossp3.direction = 'leftdown';
                        }
                        
                        else if(boss3.body.velocity.x > 0 && boss3.body.velocity.y>0){
                            boss3.animations.play("rightdown");
                            bossp3.direction = 'rightdown';
                        }
                        
                        else if(boss3.body.velocity.y < 0 && boss3.body.velocity.x < 0){
                            boss3.animations.play("leftup");
                            bossp3.direction = 'leftup';
                        }
                        
                        else if(boss3.body.velocity.y < 0 && boss3.body.velocity.x > 0){
                            boss3.animations.play("rightup");
                            bossp3.direction = 'rightup';
                        }

                        if(boss4.body.velocity.x < 0 && Math.abs(boss4.body.y-p2.body.y)<=40){
                            boss4.animations.play("left");
                            bossp4.direction = 'left';
                        }
                        else if(boss4.body.velocity.x > 0 && Math.abs(boss4.body.y-p2.body.y)<=30){
                            boss4.animations.play("right");
                            bossp4.direction = 'right';
                        }
                        else if(boss4.body.velocity.y < 0 && Math.abs(boss4.body.x-p2.body.x)<=30){
                            boss4.animations.play("up");
                            bossp4.direction = 'up';
                        }
                        else if(boss4.body.velocity.y > 0 && Math.abs(boss4.body.x-p2.body.x)<=30){
                            boss4.animations.play("down");
                            bossp4.direction = 'down';
                        }
                        else if(boss4.body.velocity.x < 0 && boss4.body.velocity.y>0){
                            boss4.animations.play("leftdown");
                            bossp4.direction = 'leftdown';
                        }
                        
                        else if(boss4.body.velocity.x > 0 && boss4.body.velocity.y>0){
                            boss4.animations.play("rightdown");
                            bossp4.direction = 'rightdown';
                        }
                        
                        else if(boss4.body.velocity.y < 0 && boss4.body.velocity.x < 0){
                            boss4.animations.play("leftup");
                            bossp4.direction = 'leftup';
                        }
                        
                        else if(boss4.body.velocity.y < 0 && boss4.body.velocity.x > 0){
                            boss4.animations.play("rightup");
                            bossp4.direction = 'rightup';
                        }
                        if(boss5.body.velocity.x < 0 && Math.abs(boss5.body.y-hi.body.y)<=40){
                            boss5.animations.play("left");
                            bossp5.direction = 'left';
                        }
                        else if(boss5.body.velocity.x > 0 && Math.abs(boss5.body.y-hi.body.y)<=30){
                            boss5.animations.play("right");
                            bossp5.direction = 'right';
                        }
                        else if(boss5.body.velocity.y < 0 && Math.abs(boss5.body.x-hi.body.x)<=30){
                            boss5.animations.play("up");
                            bossp5.direction = 'up';
                        }
                        else if(boss5.body.velocity.y > 0 && Math.abs(boss5.body.x-hi.body.x)<=30){
                            boss5.animations.play("down");
                            bossp5.direction = 'down';
                        }
                        else if(boss5.body.velocity.x < 0 && boss5.body.velocity.y>0){
                            boss5.animations.play("leftdown");
                            bossp5.direction = 'leftdown';
                        }
                        
                        else if(boss5.body.velocity.x > 0 && boss5.body.velocity.y>0){
                            boss5.animations.play("rightdown");
                            bossp5.direction = 'rightdown';
                        }
                        
                        else if(boss5.body.velocity.y < 0 && boss5.body.velocity.x < 0){
                            boss5.animations.play("leftup");
                            bossp5.direction = 'leftup';
                        }
                        
                        else if(boss5.body.velocity.y < 0 && boss5.body.velocity.x > 0){
                            boss5.animations.play("rightup");
                            bossp5.direction = 'rightup';
                        }
                        if(boss6.body.velocity.x < 0 && Math.abs(boss6.body.y-p2.body.y)<=40){
                            boss6.animations.play("left");
                            bossp6.direction = 'left';
                        }
                        else if(boss6.body.velocity.x > 0 && Math.abs(boss6.body.y-p2.body.y)<=30){
                            boss6.animations.play("right");
                            bossp6.direction = 'right';
                        }
                        else if(boss6.body.velocity.y < 0 && Math.abs(boss6.body.x-p2.body.x)<=30){
                            boss6.animations.play("up");
                            bossp6.direction = 'up';
                        }
                        else if(boss6.body.velocity.y > 0 && Math.abs(boss6.body.x-p2.body.x)<=30){
                            boss6.animations.play("down");
                            bossp6.direction = 'down';
                        }
                        else if(boss6.body.velocity.x < 0 && boss6.body.velocity.y>0){
                            boss6.animations.play("leftdown");
                            bossp6.direction = 'leftdown';
                        }
                        
                        else if(boss6.body.velocity.x > 0 && boss6.body.velocity.y>0){
                            boss6.animations.play("rightdown");
                            bossp6.direction = 'rightdown';
                        }
                        
                        else if(boss6.body.velocity.y < 0 && boss6.body.velocity.x < 0){
                            boss6.animations.play("leftup");
                            bossp6.direction = 'leftup';
                        }
                        
                        else if(boss6.body.velocity.y < 0 && boss6.body.velocity.x > 0){
                            boss6.animations.play("rightup");
                            bossp6.direction = 'rightup';
                        }
                }

                if(zombiedead >= 40 && bossp1.isDead && bossp2.isDead && bossp3.isDead && bossp4.isDead && bossp5.isDead && bossp6.isDead){
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

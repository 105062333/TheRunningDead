...
// 0 up 1 down 2 right 3 left
                ...
                /*
                for(i=bossP1Array.length-1;i>=0;i--){
                    bossP1Array[i].game.physics.arcade.moveToObject(bossP1Array[i], hi, 50);
                }

                for(i=bossP2Array.length-1;i>=0;i--){
                    bossP2Array[i].game.physics.arcade.moveToObject(bossP2Array[i], p2, 50);
                }
                */
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                if(zombiedead >= 30 && bossp1.isDead && bossp2.isDead){
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

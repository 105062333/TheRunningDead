...
*/
    ...
    drawGame: function() {
        if (this.gameState == 0){
            ...
            hi = game.add.sprite(game.world.centerX*4/3+50, game.world.centerY, "p1Anim1");
...
/*
   ...
   */         
            ...
            p1healthBarRed = game.add.sprite (game.world.centerX*4/3 - 10+50, game.world.centerY-30, "healthBarRedIMG");
            ...
            p1healthBarGreen = game.add.sprite(game.world.centerX*4/3 - 10+50, game.world.centerY-30, "healthBarGreenIMG")
            ...
            p2 = game.add.sprite(400-150, game.world.centerY, "p2Anim1");
            ...
            p2healthBarRed = game.add.sprite(400-10-150, game.world.centerY-30, "healthBarRedIMG");
            ...
            p2healthBarGreen = game.add.sprite(400-10-150, game.world.centerY-30, "healthBarGreenIMG")
            ...
            boss3 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss2");
            //bossP2Array.push(boss2);
            ...
            boss4 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss2");
            //bossP2Array.push(boss2);
            ...
            boss5 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss2");
            //bossP2Array.push(boss2);
            ...
            boss6 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss2");
            //bossP2Array.push(boss2);
    ...
    spawnNewEnemy: function(){
        for (var ToSpawn = 0; ToSpawn < 50; ToSpawn++){
            if (inter%2 == 1){
                if (this.enemySpawnLimit >= enemyTest2ArrayP1.length){
                    inter ++;
                    enemyTest2P1 = game.add.sprite(game.world.randomX + game.width, game.world.randomY + game.height, "zombieAnim2");
                ...
                if (this.enemySpawnLimit >= enemyTest2ArrayP2.length){
                    enemyTest2P2 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "zombieAnim2");
    ...
    bulletHasHitBoss6: function(bullet, Boss){
     ...
     getTreasure1: function(player, treasure){
         ...
         treasure.kill();
         var trea = game.rnd.integerInRange(1, 3);
         if(trea==1)
            gunP1Stuff.bombBullets+=10;
        else if(trea==2)
...
// 0 up 1 down 2 right 3 left
                ...
                if(Math.abs(boss1.body.y-hi.body.y)<=300 && bossp1.walking && boss1.body.y>=0 && !bossp1.isDead){
                    if(game.time.time > bossp1.time){
                        this.boss_bullet = game.add.sprite(boss1.body.x, boss1.body.y, "boss2_bullet");
                ...
                if(Math.abs(boss2.body.y-p2.body.y)<=300 && bossp2.walking && boss2.body.y>=0 && !bossp2.isDead){
                    if(game.time.time > bossp2.time){
                        this.boss_bullet = game.add.sprite(boss2.body.x, boss2.body.y, "boss2_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss3.body.y-hi.body.y)<=300 && bossp3.walking && boss3.body.y>=0 && !bossp3.isDead){
                    if(game.time.time > bossp3.time){
                        this.boss_bullet = game.add.sprite(boss3.body.x, boss3.body.y, "boss2_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss4.body.y-p2.body.y)<=300 && bossp4.walking && boss4.body.y>=0 && !bossp4.isDead){
                    if(game.time.time > bossp4.time){
                        this.boss_bullet = game.add.sprite(boss4.body.x, boss4.body.y, "boss2_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss5.body.y-hi.body.y)<=300 && bossp5.walking && boss5.body.y>=0 && !bossp5.isDead){
                    if(game.time.time > bossp5.time){
                        this.boss_bullet = game.add.sprite(boss5.body.x, boss5.body.y, "boss2_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss6.body.y-p2.body.y)<=300 && bossp6.walking && boss6.body.y>=0 && !bossp6.isDead){
                    if(game.time.time > bossp6.time){
                        this.boss_bullet6 = game.add.sprite(boss6.body.x, boss6.body.y, "boss2_bullet");
                        ...
                        if(bossp6.direction=='left'){
                                ...
                                this.boss_bullet6.body.velocity.x= -400;
                            ...
                            this.boss_bullet6.body.velocity.y= -400;
                            ...
                            boss6.frame = 44;
                                ...
                                this.boss_bullet6.body.velocity.y= 300;
                                this.boss_bullet6.body.velocity.x= -300;
                ...
                if(bossp3.walking)
                    boss3.game.physics.arcade.moveToObject(boss3, hi, 60);

                if(bossp4.walking)
                    boss4.game.physics.arcade.moveToObject(boss4, p2, 60);

                if(bossp5.walking)
                    boss5.game.physics.arcade.moveToObject(boss5, hi, 60);

                if(bossp6.walking)
                    boss6.game.physics.arcade.moveToObject(boss6, p2, 60);
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                if(zombiedead >= 50 && bossp1.isDead && bossp2.isDead && bossp3.isDead && bossp4.isDead && bossp5.isDead && bossp6.isDead){
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

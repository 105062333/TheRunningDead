   ...
   */         
    ...
    bulletHasHitBoss1: function(bullet, Boss){
        ...
        if(bossp1.hp==0){
            ...
            //treasure = game.add.sprite(Boss.body.x, Boss.body.y, "treasure");
...
// 0 up 1 down 2 right 3 left
                ...
                for(var index = gunP1Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.collide(gunP1Stuff.explosionArray[index], boss1, this.explosionHasHitBoss, null, this);
                }
    
                for(var index = gunP2Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.collide(gunP2Stuff.explosionArray[index], boss1, this.explosionHasHitBoss, null, this);
                }        

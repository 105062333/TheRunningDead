...
/*
   ...
   */         
            ...
            boss1 = game.add.sprite(540, -100, "boss3");
            ...
            boss2 = game.add.sprite(540, -100, "boss3");
            ...
            boss3 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss3");
            //bossP2Array.push(boss2);
            ...
            boss4 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss3");
            //bossP2Array.push(boss2);
            ...
            boss5 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss3");
            //bossP2Array.push(boss2);
            ...
            boss6 = game.add.sprite(game.world.randomX - game.width, game.world.randomY - game.height, "boss3");
            //bossP2Array.push(boss2);
    ...
    spawnNewEnemy: function(){
        for (var ToSpawn = 0; ToSpawn < 60; ToSpawn++){
            if (inter%2 == 1){
...
// 0 up 1 down 2 right 3 left
                ...
                if(Math.abs(boss1.body.y-hi.body.y)<=300 && bossp1.walking && boss1.body.y>=0 && !bossp1.isDead){
                    if(game.time.time > bossp1.time){
                        this.boss_bullet = game.add.sprite(boss1.body.x, boss1.body.y, "boss3_bullet");
                        ...
                        if(bossp1.direction=='left'){
                                ...
                                this.boss_bullet.body.velocity.x= -600;
                            ...
                            this.boss_bullet.body.velocity.y= -600;
                ...
                if(Math.abs(boss2.body.y-p2.body.y)<=300 && bossp2.walking && boss2.body.y>=0 && !bossp2.isDead){
                    if(game.time.time > bossp2.time){
                        this.boss_bullet = game.add.sprite(boss2.body.x, boss2.body.y, "boss3_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss3.body.y-hi.body.y)<=300 && bossp3.walking && boss3.body.y>=0 && !bossp3.isDead){
                    if(game.time.time > bossp3.time){
                        this.boss_bullet = game.add.sprite(boss3.body.x, boss3.body.y, "boss3_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss4.body.y-p2.body.y)<=300 && bossp4.walking && boss4.body.y>=0 && !bossp4.isDead){
                    if(game.time.time > bossp4.time){
                        this.boss_bullet = game.add.sprite(boss4.body.x, boss4.body.y, "boss3_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss5.body.y-hi.body.y)<=300 && bossp5.walking && boss5.body.y>=0 && !bossp5.isDead){
                    if(game.time.time > bossp5.time){
                        this.boss_bullet = game.add.sprite(boss5.body.x, boss5.body.y, "boss3_bullet");
                        this.boss_bullet.scale.x=.2;
                        this.boss_bullet.scale.y=.2;
                        this.boss_bullet.anchor.set(0.5, 0.5);
                        game.physics.arcade.enable(this.boss_bullet);
                ...
                if(Math.abs(boss6.body.y-p2.body.y)<=300 && bossp6.walking && boss6.body.y>=0 && !bossp6.isDead){
                    if(game.time.time > bossp6.time){
                        this.boss_bullet6 = game.add.sprite(boss6.body.x, boss6.body.y, "boss3_bullet");
                        ...
                        if(bossp6.direction=='left'){
                                ...
                                this.boss_bullet6.body.velocity.x= -600;
                            ...
                            this.boss_bullet6.body.velocity.y= -600;
                ...
                if(bossp1.walking)
                    boss1.game.physics.arcade.moveToObject(boss1, hi, 70);

                if(bossp2.walking)
                    boss2.game.physics.arcade.moveToObject(boss2, p2, 70);

                if(bossp3.walking)
                    boss3.game.physics.arcade.moveToObject(boss3, hi, 70);

                if(bossp4.walking)
                    boss4.game.physics.arcade.moveToObject(boss4, p2, 70);

                if(bossp5.walking)
                    boss5.game.physics.arcade.moveToObject(boss5, hi, 70);

                if(bossp6.walking)
                    boss6.game.physics.arcade.moveToObject(boss6, p2, 70);
               ...
               // enemyTest.game.physics.arcade.moveToObject(enemyTest, hi, 50);
                ...
                for (var i = enemyTest2ArrayP1.length - 1; i >= 0 ; i--){
                    if (!enemyTest2ArrayP1[i].isDead){
                        ...
                        enemyTest2ArrayP1[i].game.physics.arcade.moveToObject(enemyTest2ArrayP1[i], hi, 70);
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                for (var i = enemyTest2ArrayP2.length - 1; i >= 0; i--){
                    if (!enemyTest2ArrayP2[i].isDead){
                        ...
                        enemyTest2ArrayP2[i].game.physics.arcade.moveToObject(enemyTest2ArrayP2[i], p2, 70);
                ...
                if(zombiedead >= 60 && bossp1.isDead && bossp2.isDead && bossp3.isDead && bossp4.isDead && bossp5.isDead && bossp6.isDead){
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

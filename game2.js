...
/*
   ...
   */         
    ...
    spawnNewEnemy: function(){
        for (var ToSpawn = 0; ToSpawn < 20; ToSpawn++){
            if (inter%2 == 1){
...
/*                    if (bullets != null && enemyTest2ArrayP1[i] != null){
                ...
                /*for(var index = gunP1Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss1, this.explosionHasHitEnemy, null, this);
                    game.physics.arcade.overlap(gunP1Stuff.explosionArray[index], boss2, this.explosionHasHitEnemy, null, this);
                }

                for(var index = gunP2Stuff.explosionArray.length-1;index>=0;index--){
                    game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss1, this.explosionHasHitEnemy, null, this);
                    game.physics.arcade.overlap(gunP2Stuff.explosionArray[index], boss2, this.explosionHasHitEnemy, null, this);
                }*/
                ...
                if(zombiedead >= 20 && bossp1.isDead && bossp2.isDead){
                    this.winning();
                    checkdoor = true;
                    zombiedead = 0;
                }

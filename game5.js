...
/*
   ...
   */         
            ...
            p2 = game.add.sprite(game.world.centerX*4/3-50, game.world.centerY, "p2Anim1");
            ...
            p2healthBarRed = game.add.sprite(game.world.centerX*4/3 - 10-50, game.world.centerY-30, "healthBarRedIMG");
            ...
            p2healthBarGreen = game.add.sprite(game.world.centerX*4/3 - 10-50, game.world.centerY-30, "healthBarGreenIMG")
    ...
    bulletHasHitBoss6: function(bullet, Boss){
     ...
     getTreasure1: function(player, treasure){
         ...
         treasure.kill();
         var trea = game.rnd.integerInRange(1, 2);
         if(trea==1)
            gunP1Stuff.bombBullets+=10;
        else

var p1winState = {
   ...
   create:function () {
    ...
    this.button4  = game.add.audio('button4');
       ...
       var nameLabel = game.add.text(game.width/2, -100, 'Player 1',{ font: '60px Nosifer', fill: '#CD0000' }); 
        ...
        this.levelLabel = game.add.text(550, 600, 'BACK TO MENU', { font: '35px Luckiest Guy', fill: '#ffffff' });
